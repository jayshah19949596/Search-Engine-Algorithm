...
print("The Crwaled list of pages are as follows :")
if 'http://udacity.com/cs101x/urank/index.html' in graph:
    for element in graph['http://udacity.com/cs101x/urank/index.html']:
        print(element)
...
print("")
print("The webpages and their page rank are ass follows : ")
for key in ranks:
    print(key, ranks[key])
